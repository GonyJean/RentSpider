...
function getSpysInfo(Num) {
  ...
  superagent
    ...
    .set({
      "User-Agent":
        " Mozilla/5.0 (Windows NT 10.0; WOW64)/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36"
    })
    .set({
      Accept:
      ...
      list.each(function(i, e) {
        if (i > 2) {
          ...
          if (
            ...
            var portBefore1 = $(this)
              .find("td:nth-child(1)")
              .find(".spy14")
              .children()[0].children[0].data;
            var portBefore2 = portBefore1.substring(
              portBefore1.indexOf("+") + 1
            );
...
function getCountryProxy(ip) {
  ...
  async.mapLimit(countryUrlList,3, 
        ...
        superagent
          ...
          .end(function(err, res) {
            ...
            arr.map(function(l, i) {
              if (l.length >= 18) {
                obj[l.substring(l.indexOf("="), -1)] = l
                  .substring(l.indexOf("=") + 1)
                  .substring("^", l.substring(l.indexOf("=") + 1).indexOf("^"));
              }
              if (l.length <= 15) {
                objDist[l.substring(l.indexOf("="), -1)] = l.substring(
                  l.indexOf("=") + 1
                );
              }
            });
            list.each(function(i, e) {
              if (i > 2) {
                ...
                if (
                  ...
                  var portBefore3 = portBefore2.substring(
                    portBefore2.length - 1,
                    -1
                  );
